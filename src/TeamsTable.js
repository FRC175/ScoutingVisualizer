...
const columns = [
  { field: 'id', headerName: 'Team #', type: 'number', width: 100 },
  {
    field: 'avgTeleopSpeaker',
    headerName: 'Avg. T-Speaker',
    type: 'number',
    width: 150,
    editable: false,
  },
  {
    field: 'avgTeleopAmp',
    headerName: 'Avg. T-Amp',
    type: 'number',
    width: 150,
    editable: false,
  },
  {
    field: 'avgAutoSpeaker',
    headerName: 'Avg. A-Speaker',
    width: 150,
    type: 'number',
    editable: false
    // valueGetter: (params) =>
  ...
  {
    field: 'harmony2Percent',
    headerName: '% harmony 2',
    type: 'number',
    width: 150,
    editable: false,
  },
  {
    field: 'carriedPercent',
    headerName: '% carried',
    type: 'number',
    width: 125,
    editable: false,
  ...
  // {
  //   field: 'teamPowerRanking',
  //   headerName: 'Avg. Team Power',
  //   type: 'number',
  //   width: 100,
  //   editable: false,
  // },
